...
def get_location_data(player: Optional[int], options: Optional[MIUUltraOptions]):
    ...
    locations += (
        ...
        MIUUltraLocation("Wave Pool Complete", Regions.ch2, "wave_pool_update-c", lambda state: logic.has_medals(Regions.ch2.chapter_number, state)),
    ...
    if not options or options.final_chapter.value>0:
        ...
        locations += (
            ...
            MIUUltraLocation("Hyperloop Complete", Regions.ch4, "hyperloop-c", lambda state: logic.has_medals(Regions.ch4.chapter_number, state)),
    ...
    if not options or options.final_chapter>1:
        ...
        locations += (
            ...
            MIUUltraLocation("Glacier Complete", Regions.ch5, "glacier_v2-c", lambda state: logic.has_medals(Regions.ch5.chapter_number, state)),
    ...
    if not options or options.bonus_arc_chapters>0:
        ...
        locations+=(
            ...
            MIUUltraLocation("Onward and Upward Complete", Regions.ba1, "onward_and_upward_mayhem-c", lambda state: state.has_all({'Super Jump', 'Gravity Surfaces'}, player) and logic.has_gold_medals(Regions.ba1.chapter_number, state)),
            ...
            MIUUltraLocation("Triple Divide Complete", Regions.ba1, "3divide-c", lambda state: logic.has_gold_medals(Regions.ba1.chapter_number, state)),
            ...
            MIUUltraLocation("River Vantage Complete", Regions.ba1, "rivervantage-c", lambda state: state.has_all({'Super Jump', 'Boost'}, player) and logic.has_gold_medals(Regions.ba1.chapter_number, state)),
            ...
            MIUUltraLocation("Epoch Complete", Regions.ba1, "epoch-c", lambda state: logic.has_gold_medals(Regions.ba1.chapter_number, state)),
        ...
        if not options or options.medal_types>0:
            locations+=(
                ...
                MIUUltraLocation("River Vantage Silver Medal", Regions.ba1, "rivervantage-s", lambda state: state.has_all({'Super Jump', 'Boost'}, player) and logic.has_gold_medals(Regions.ba1.chapter_number, state)),
        ...
        if not options or options.medal_types>1:
            locations+=(
                ...
                MIUUltraLocation("River Vantage Gold Medal", Regions.ba1, "rivervantage-g", lambda state: state.has_all({'Super Jump', 'Boost'}, player) and logic.has_gold_medals(Regions.ba1.chapter_number, state)),
        ...
        if not options or options.medal_types>2:
            locations+=(
                ...
                MIUUltraLocation("River Vantage Diamond Medal", Regions.ba1, "rivervantage-d", lambda state: state.has_all({'Super Jump', 'Boost'}, player) and logic.has_gold_medals(Regions.ba1.chapter_number, state)),
    ...
    if not options or options.bonus_arc_chapters>1:
        ...
        locations+=(
            ...
            MIUUltraLocation("Crystalline Matrix Complete", Regions.ba2, "crystalmatrix-c", lambda state: logic.has_gold_medals(Regions.ba2.chapter_number, state)),
    ...
    if not options or options.bonus_arc_chapters>2:
        ...
        locations+=(
            ...
            MIUUltraLocation("Retrograde Rally Complete", Regions.ba3, "retro-c", lambda state: logic.has_gold_medals(Regions.ba3.chapter_number, state)),
